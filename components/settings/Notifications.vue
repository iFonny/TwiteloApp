      ...
      <li>
        <div class="columns is-mobile">
          ...
          <div class="column has-text-right settings-content">
            <b-switch @click.native="changeSwitchNotifications('mp_twitter')" :value="$store.state.user.info.settings.notifications.mp_twitter" type="is-success" size="is-medium" :disabled="switchDisabled.mp_twitter"></b-switch>
          </div>
        </div>
      </li>
    </ul>
